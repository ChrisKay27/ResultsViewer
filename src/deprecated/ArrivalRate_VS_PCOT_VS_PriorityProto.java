 ...
 */
public class ArrivalRate_VS_PCOT_VS_PriorityProto extends JFrame{
    ...
    public static void main(String[] args) {
        ...
        JFreeChart lineChart = ChartFactory.createLineChart("deprecated.ArrivalRate_VS_PCOT_VS_PriorityProto", "Arrival Rate", "PCOT", dataset);
